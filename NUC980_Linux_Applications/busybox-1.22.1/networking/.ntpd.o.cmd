...
deps_networking/ntpd.o := \
  ...
  include/shadow_.h \
  include/xatonum.h \
  /usr/local/arm_linux_4.8/usr/include/math.h \
  /usr/local/arm_linux_4.8/usr/include/bits/huge_val.h \
  /usr/local/arm_linux_4.8/usr/include/bits/huge_valf.h \
  /usr/local/arm_linux_4.8/usr/include/bits/huge_vall.h \
  /usr/local/arm_linux_4.8/usr/include/bits/inf.h \
  /usr/local/arm_linux_4.8/usr/include/bits/nan.h \
  /usr/local/arm_linux_4.8/usr/include/bits/mathdef.h \
  /usr/local/arm_linux_4.8/usr/include/bits/mathcalls.h \
  /usr/local/arm_linux_4.8/usr/include/netinet/ip.h \
  /usr/local/arm_linux_4.8/usr/include/sys/timex.h \
