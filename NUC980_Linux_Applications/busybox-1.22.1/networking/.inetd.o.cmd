...
deps_networking/inetd.o := \
  ...
  /usr/local/arm_linux_4.8/usr/include/sys/un.h \
  ...
  include/shadow_.h \
  include/xatonum.h \
  /usr/local/arm_linux_4.8/usr/include/rpc/rpc.h \
  /usr/local/arm_linux_4.8/usr/include/rpc/types.h \
  /usr/local/arm_linux_4.8/usr/include/rpc/xdr.h \
  /usr/local/arm_linux_4.8/usr/include/rpc/auth.h \
  /usr/local/arm_linux_4.8/usr/include/rpc/clnt.h \
  /usr/local/arm_linux_4.8/usr/include/rpc/rpc_msg.h \
  /usr/local/arm_linux_4.8/usr/include/rpc/auth_unix.h \
  /usr/local/arm_linux_4.8/usr/include/rpc/auth_des.h \
  /usr/local/arm_linux_4.8/usr/include/rpc/svc.h \
  /usr/local/arm_linux_4.8/usr/include/rpc/svc_auth.h \
  /usr/local/arm_linux_4.8/usr/include/rpc/pmap_clnt.h \
