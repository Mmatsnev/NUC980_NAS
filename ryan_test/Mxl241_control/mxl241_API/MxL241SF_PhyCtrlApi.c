...
const UINT8 MxLWareDrvVersion[] = {2, 1, 14, 1};
...
MXL_STATUS MxL_ConfigDemodSymbolRate(PMXL_SYMBOL_RATE_T SymbolRatePtr)
{
  ...
  MxL_DLL_DEBUG0("MXL_DEMOD_SYMBOL_RATE_CFG : SymbolType=%d, SymbolRate=%d, SymbolRate256=%d, OobSymbolRate=%d \n",
     SymbolRatePtr->SymbolType, (UINT32)SymbolRatePtr->SymbolRate, (UINT32)SymbolRatePtr->SymbolRate256, (UINT32)SymbolRatePtr->OobSymbolRate);
...
MXL_STATUS MxL_GetDemodTimingOffset(PMXL_DEMOD_TIMINGOFFSET_INFO_T TimingOffsetPtr)
{
  ...
  TimingOffsetPtr->TimingOffset = (godardAcc * 1000000) / tmpRate;
